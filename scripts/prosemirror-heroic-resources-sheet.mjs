import DrawSteelHeroSheet from "../../../../systems/draw-steel/src/module/applications/sheets/hero-sheet.mjs";
import { moduleID } from "./constants.mjs";

const { ux } = foundry.applications;

export class CustomDrawSteelActorSheet extends DrawSteelHeroSheet {
    ...
    _addProseMirrorNotes($html) {
        ...
        if (this.isEditMode) {
            ...
            if (!resourcesFieldset.length) return;
            
            if (!notes) return;
            
            TextEditor.enrichHTML(notes, {
